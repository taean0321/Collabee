...
<head>
	...
	<style>
	    ...
	    /* 로그인 ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ */
	    #login{
	    	display: none;
	    }
	    .overlay{
		...
		/* 비밀번호 재설정ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ */
		#resetPW{
			display: none; 
		}
		.button_x_class2 {
		...
		.request_email_container{
			position: relative;
		    display: flex;
		    flex-direction: column;
		    margin-bottom: 40px;
		}
		.label_for_request_email{
			font-size: 12px;
		    line-height: 1.5;
		    font-weight: bold;
		    color: rgb(136, 136, 136);
		}
		.inputBox_for_request_email{
			display: flex;
		    flex-direction: row;
		    align-items: center;
		...
		.input_for_request_email:focus {
			outline: none;
    		border-bottom: 1px solid rgb(237, 84, 84);
		}
		.button_for_resetPW{
			cursor: pointer;
		    flex: 0 1 auto;
		...
		.button_go_login:hover{
			    color: rgb(179, 142, 34);
		}
		
		/* 회원가입 ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ */
		#signUp{
			display: none;
		}
		.white_box_center_signUp{
			display: flex;
		    position: relative;
		    width: 404px;
		    min-height: 310px;
		...
		.signUp_header_btn_svg{
			display: inline-block;
		    vertical-align: middle;
		    shape-rendering: inherit;
		}
		.signUp_header_btn_path{
			transition: fill 0.2s ease 0s;
    		fill: rgb(136, 136, 136);
		}
		.signUp_header_btn_path:hover{
			fill: rgb(83, 83, 83);
		}
		.signUp_body{
			flex: 1 1 auto;
		...
		.signUp_body_social_btn:hover{
		background-color: rgb(247, 246, 245);		
		}
		.signUp_body_social_btn>div:last-child{
			width: 100%;
		    font-size: 14px;
		    margin: 6px 0px;
		}
		.signUp_body_btn_iconcontainer{
			position: absolute;
		    padding: 6px;
		}
		.signUp_body_divider{
		...
		.signUp_footer_btn:hover{
			color: rgb(179, 142, 34);	
		}
		/* signUp1 ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ */
		#signUp1{
			display: none;
		}
	    .signUp1_modal{
		...
		/* signUp2ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ */
		#signUp2{
			display: none;
		}
		.go_signUp1_btn{
		...
		.go_signUp1_btn:before{
		    content: "< ";
		}
		
		/* signUp3ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ */
		#signUp3{
			display:none;
		}
	    .signUp3_content{
		...
		/* mini_menuㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ */
	    .mini_menu_bold{
	        font-weight:bold;
	    } 
	    #collabee_modal_mini_menu{
	    	display: flex;
	    	flex-flow: row wrap;
	    	width: 476px;
	    	margin-left: -150px;
	    ...
	    #collabee_modal_mini_menu>li:hover{
	    	background-color: #fafafa;
	    }
	    #collabee_modal_mini_menu>li>a{
	    	display: block;
	    	box-sizing: border-box;
	    	padding: 10px 12px;
	    	font-size: 14px;
	    ...
	    #collabee_modal_mini_menu>li>a>span{
	    	display: block;
	    	font-size: 14px;
	    	line-height: 18px;
	    ...
	    #collabee_modal_mini_menu_container{
	    	display: none;
	    }
	    #collabee_modal_mini_menu_btn:hover #collabee_modal_mini_menu_container{
			display: block;
		}
	                ...
	                <li id="collabee_modal_mini_menu_btn" style="width:150px; height:70px;">문서기반 협업툴
						...
						<div id="collabee_modal_mini_menu_container">
			                <ul id="collabee_modal_mini_menu">
			                	<li><a href=""><span class="mini_menu_bold">협업공간</span><span>동료와 함께하는 공간</span></a></li>
			                	<li><a href="homepage_1.jsp"><span class="mini_menu_bold">문서</span><span>협업을 시작하는 실시간 동시편집 문서</span></a></li>
			                	<li><a href=""><span class="mini_menu_bold">실시간 대화</span><span>모든 문서, 할 일, 파일에서 나누는 실시간 커뮤니케이션</span></a></li>
			                	<li><a href="homepage_2.jsp"><span class="mini_menu_bold">이슈 업데이트</span><span>나에게 필요한 소식을 문서별<br/>로 일려주는 알림 리스트</span></a></li>
			                	<li><a href=""><span class="mini_menu_bold">캘린더</span><span>나와 동료의 일정/할 일 파악 및 스케쥴 관리</span></a></li>
			                	<li><a href="homepage_3.jsp"><span class="mini_menu_bold">칸반</span><span>문서 진행상황 파악 및 관리</span></a></li>
			                	<li><a href=""><span class="mini_menu_bold">간트차트</span><span>쉽고 빠른 일정 추적과 관리</span></a></li>
			                	<li><a href="homepage_4.jsp"><span class="mini_menu_bold">컨텐츠 모음</span><span>파일, 할 일, 의사결정, 링크를 쉽고 빠르게 찾을 수 있는 공간</span></a></li>
			                	<li style="margin-right: 150px;"><a href=""><span class="mini_menu_bold">관리자 기능</span><span>동료 관리, 협업공간 관리</span></a></li>
